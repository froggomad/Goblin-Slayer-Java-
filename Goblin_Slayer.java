...
public class Goblin_Slayer {
    ...
    public static class Character {
        ...
        public void equipSword(Sword sword) {
            ...
            System.out.println("It does " + sword.damage + " damage.");
        }

        public void attack(Character enemy) {
            if (this.sword != null) {
                enemy.hitpoints -= this.sword.damage;
                System.out.println(name + " hit the " + enemy.name + " for " + this.sword.damage + " damage.");
                System.out.println(enemy.name + " has " + enemy.hitpoints + " hitpoints left.");                
            } else {
                System.out.println(name + " doesn't have a sword equipped.");
            }
        }
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Welcome, brave " + player1.name + "! You find yourself in a pitch-black dungeon filled with the stench of death, teeming with goblins.");
        ...
        for (int i = 0; i < swords.length; i++) {
            System.out.println((i + 1) + ": " + swords[i].name + " (Damage: " + swords[i].damage + ")");
        }
        ...
        if (player1.hitpoints <= 0) {
            System.out.println("\nAlas, brave " + player1.name + ", you have succumbed to the goblin's wrath. Your life lessens and the cold embrace of death claims you. Your valiant struggle shall be lost to the darkness of the dungeon.");
        } else if (player1.numberEnemiesKilled >= 3) {
            System.out.println("\nAgainst all odds, " + player1.name + ", you have vanquished the goblins and escaped the clutches of this hellish dungeon! Your courage and skill have led you to victory, but the scars of battle will forever remain.");
        }
